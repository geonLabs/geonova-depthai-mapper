...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--square-size-mm", type=float, default=30.0)
    parser.add_argument("--samples", type=int, default=20)
    parser.add_argument("--min-samples", type=int, default=12)
    parser.add_argument("--fps", type=float, default=15.0)
    parser.add_argument("--width", type=int, default=1280)
    parser.add_argument("--height", type=int, default=720)
    parser.add_argument("--output-dir", type=Path, default=Path("test_output/checkerboard"))
    parser.add_argument("--max-rms-px", type=float, default=1.0)
    parser.add_argument("--auto-capture", action="store_true")
    parser.add_argument("--auto-interval-s", type=float, default=0.8)
    parser.add_argument(
        "--detection-hold-s",
        type=float,
        default=1.5,
